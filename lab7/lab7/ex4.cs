/*namespace Utils
{
    ...
    class Utils
    {
        ...
        {
            if (x is IFormattable) return true;
            return false;
        }
        ...
        {
            int i = 0; ulong ul = 0; string s = "Test";
            Console.WriteLine( IsItFormatable(i));
            Console.WriteLine(IsItFormatable(ul));
            Console.WriteLine(IsItFormatable(s));
        }
    }
}*/
